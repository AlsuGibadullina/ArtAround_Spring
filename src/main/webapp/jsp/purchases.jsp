    ...
    <div class="container">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item"><a href="${pageContext.request.contextPath}/registration" class="nav-link">Регистрация</a></li>
    ...
    <c:forEach var="product" items="${products}">
        <div class="row justify-content-lg-center m-lg-1 p-lg-1 border border-secondary">
            ...
            <div class="col-2 m-5">
                <ul>
                    <li>
                        <button id="remove${product.id}" onclick="removeFromPurchases(${product.id})">Удалить из покупок</button>
                    </li>
                </ul>
            </div>
        </div>
...
<script>
    function removeFromPurchases(productId) {
        $.ajax({
            url: '/purchases',           /* Куда пойдет запрос */
